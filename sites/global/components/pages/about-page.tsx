...
const values = [
  {
    ...
    description: 'Every solution begins with deep analysis of your strategic context, competitive landscape, and growth objectives. We architect intelligence systems tailored to your specific challenges.',
  },
  {
    icon: Target,
    title: 'Technology-Enabled',
    description: 'We leverage cutting-edge platforms from Microsoft, AWS, and specialized analytics partners to build robust, scalable solutions driven by your business requirements.',
  },
  {
    icon: Award,
    title: 'Outcome-Focused',
    description: 'Success isn\'t measured by deliverables but by business impact. We establish clear metrics at engagement outset and remain accountable for measurable improvements.',
  },
  {
    icon: Users,
    title: 'Partnership-Oriented',
    description: 'We don\'t parachute in with prescriptive recommendations. Our engagements are characterized by deep collaboration, knowledge transfer, and sustained partnership.',
  },
]
...
export function GlobalAboutPage() {
                ...
                <div className="relative p-8 rounded-3xl glass-card">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-6 rounded-2xl bg-[#F7AE57]/10 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Solutions Deployed</p>
                    </div>
                    <div className="p-6 rounded-2xl bg-[#F7AE57]/10 text-center">
                    ...
                    <div className="p-6 rounded-2xl bg-[#0E78AA]/10 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Continents Served</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="gradient-text">Attributes</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                We combine strategic foresight with technical mastery to deliver solutions
                that don't just solve today's problems but anticipate tomorrow's opportunities.
              </p>
            </div>
