...
const stats = [
  {
    ...
    description: 'Partnering with Nigerian organisations across sectors',
    icon: Award,
  },
  {
    value: 150,
    ...
    description: 'Across Nigeria\'s major commercial centres',
    icon: Users,
  },
  {
    value: 50,
    ...
    description: 'Measurable value through strategic solutions',
    icon: TrendingUp,
  },
  {
    value: 95,
    ...
    description: 'Across our engagement portfolio',
    icon: MapPin,
  },
]
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm text-sm font-medium text-gray-700 mb-6">
            ...
            <span>Our Impact in Nigeria</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Proven Excellence in <span className="text-brand-primary">Nigerian Market</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Delivering strategic intelligence solutions that drive measurable transformation
            across Nigeria&apos;s dynamic business landscape.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.5} className="mt-16 text-center">
          <p className="text-gray-600 text-sm">
            Serving clients across <span className="text-brand-primary font-semibold">Lagos, Abuja, Port Harcourt</span> and Nigeria&apos;s major commercial centres
          </p>
        </FadeIn>
      </div>
    </section>
